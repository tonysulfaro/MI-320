...
The Presidential Inaugural Speeches dataset contains data on each Speech given my a president in the United States. Each entry in the dataset includes:

* A Number
* Name (President Name)
* Inagural Address (What type of address it was, first, second)
* Date (Date addres was given. eg: Monday, March 4, 1793)
* Text (Full text of speech)

The US Presidents dataset however just has one entry per president and some attributes associated with them such as: 

* start (when president was elected)
* end (when term ended)
* president (who was the president)
* prior (what their job was before president)
* party (supporting party. eg:Federalist, Democratic)
* vice (who the vice president was)
