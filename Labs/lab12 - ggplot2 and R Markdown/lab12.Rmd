...
# Question 11
After adding the population variable as the size of the bubbles in the scatterplot. It would appear that states with more population have a higher tendancy of crime.
...
# Question 13
Two variables with a strong correlaction from the scatterplot matrix were robbery and murder. There was a positive correlation between the two and had a correlation value of 0.755.
